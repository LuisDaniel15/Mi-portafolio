...
export const metadata = {
  title: "Sistema de gestión para guarderías",
  description: "Aplicación web para administrar niños, controlar asistencia y mejorar la organización interna de guarderías.",
};

const funcionalidades = [
  { icono: "👶", titulo: "Gestión de niños", items: ["Registro y gestión de niños", "Organización de información básica"] },
  { icono: "📋", titulo: "Control de asistencia", items: ["Registro diario de asistencia", "Visualización de datos de forma estructurada"] },
];

const tecnologias = [
  { area: "Frontend", stack: "Next.js" },
  { area: "Backend", stack: "FastAPI" },
  { area: "Base de datos", stack: "PostgreSQL" },
];

const decisiones = [
  "Uso de FastAPI para un backend rápido y moderno con Python.",
  "Next.js en el frontend para una interfaz fluida y escalable.",
  "PostgreSQL como base de datos robusta para gestión de información estructurada.",
];
    ...
    <main className="bg-white dark:bg-gray-900 min-h-screen">
      ...
      <header className="fixed top-0 left-0 w-full z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border-b border-gray-200 dark:border-gray-800">
        <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <a  href="https://github.com/tuusuario/guarderia"
            target="_blank"
      ...
      <div className="pt-24 pb-20">
        ...
        <section className="max-w-5xl mx-auto px-6 py-16 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 dark:text-white mb-4 leading-tight">
            ...
            <span className="text-blue-500">para guarderías</span>
          </h1>
          <p className="text-lg text-gray-500 dark:text-gray-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            Aplicación web diseñada para administrar niños, controlar la asistencia y mejorar la organización interna de guarderías.
          </p>
        ...
        <section className="max-w-5xl mx-auto px-6 mb-24">
          <div className="bg-blue-50 dark:bg-blue-500/10 rounded-2xl p-8 border border-blue-100 dark:border-blue-500/20">
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm">
              Muchos centros de cuidado infantil gestionan la información de los niños y su asistencia de forma manual,
              lo que genera desorganización y dificultad para acceder a los datos. Este sistema busca centralizar
              la información en una sola plataforma, facilitando la gestión diaria.
            </p>
          </div>
        </section>
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700 flex flex-col md:flex-row items-start md:items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                Desarrollo completo del sistema, incluyendo la lógica backend, estructura de base de datos e interfaz de usuario.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-5xl mx-auto px-6 mb-24">
          <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700">
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
              El sistema permite mejorar la organización interna de guarderías, facilitando el control
              de información y reduciendo procesos manuales.
            </p>
          </div>
        </section>
